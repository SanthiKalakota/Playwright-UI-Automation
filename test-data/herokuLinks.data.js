// Canonical homepage links used for E2E coverage and drift detection.
const herokuLinks = [
  { name: 'A/B Testing', path: '/abtest' },
  { name: 'Add/Remove Elements', path: '/add_remove_elements/' },
  { name: 'Basic Auth', path: '/basic_auth' },
  ...
  { name: 'File Download', path: '/download' },
  ...
  { name: 'JQuery UI Menus', path: '/jqueryui/menu' },
  ...
  { name: 'Multiple Windows', path: '/windows' },
  { name: 'Nested Frames', path: '/nested_frames' },
  { name: 'Notification Messages', path: '/notification_message', validPaths: ['/notification_message', '/notification_message_rendered'] },
  { name: 'Redirect Link', path: '/redirector' },
  { name: 'Secure File Download', path: '/download_secure', validPaths: ['/download_secure', '/login'] },
  { name: 'Shadow DOM', path: '/shadowdom' },
  { name: 'Shifting Content', path: '/shifting_content' },
  { name: 'Slow Resources', path: '/slow' },
  { name: 'Sortable Data Tables', path: '/tables' },
  { name: 'Status Codes', path: '/status_codes' },
  { name: 'Typos', path: '/typos' },
  { name: 'WYSIWYG Editor', path: '/tinymce' },
];

module.exports = { herokuLinks };
